...
public class Board extends JPanel implements ActionListener 
{
    ...
    private Image ii;
    private final Color dotcolor = new Color(randomGenerator.nextInt(255), randomGenerator.nextInt(255), randomGenerator.nextInt(255));//there is 1920amount of red, 192 amount of green , and no amount of blue  
